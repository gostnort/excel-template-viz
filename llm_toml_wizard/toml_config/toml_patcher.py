...
Phase A: 从 wizard/toml_patcher.py 迁移，WorkflowState 来自 llm_toml_wizard.workflow.state。
"""
...
from llm_toml_wizard.workflow.state import FieldState, WorkflowState
